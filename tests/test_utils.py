...
class TestPolychromeUtils:
    ...
    def test_invalidHex_length(self):
        ...
        assert not utils.validHex("#0066C") and not utils.validHex("#06CC") and not utils.validHex("#00666CC")
    ...
    def test_invalidHex_rgb(self):
        ...
        assert utils.validRGB((38,29,103)) and not utils.validHex((38,29,103))
    ...
    def test_invalidRGB_length(self):
        ...
        assert not utils.validRGB((42, 42)) and not utils.validRGB((42, 200, 100, 38))
